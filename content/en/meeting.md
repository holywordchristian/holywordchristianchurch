...
<section class="meeting-wrap">
  <section class="meeting-intro">
    <p class="section-kicker">WORSHIP &amp; FELLOWSHIP · SCHEDULE</p>
    <h2>Join us for worship, prayer, and Christian community</h2>
    <p>Whether you are visiting for the first time or already walking with our church family, you are warmly welcome to join Sunday worship, Sunday school, prayer gatherings, and fellowship throughout the week.</p>
  </section>

  <section class="meeting-highlights">
    <article class="meeting-highlight">
      <p class="meeting-highlight__eyebrow">Sunday Worship</p>
      <h3>Every Sunday at 2:00 PM</h3>
      <p>Our main service meets in person, with online access available for those joining remotely.</p>
    </article>
    <article class="meeting-highlight">
      <p class="meeting-highlight__eyebrow">Sunday School</p>
      <h3>For adults and children</h3>
      <p>Adult Sunday School begins at 4:00 PM, while Children's Sunday School runs alongside the Sunday service.</p>
    </article>
    <article class="meeting-highlight">
      <p class="meeting-highlight__eyebrow">Prayer &amp; Fellowship</p>
      <h3>Stay connected through the week</h3>
      <p>Prayer meeting, seeker class, growth class, and fellowship gatherings help us keep growing together in faith and care.</p>
    </article>
  </section>

  <section class="meeting-section">
    <div class="meeting-section__heading">
      <p class="section-kicker">SCHEDULE · WEEKLY GATHERINGS</p>
      <h3>Meeting times</h3>
    </div>
  ...
  <section class="meeting-section">
    ...
    <figure class="wp-block-gallery has-nested-images columns-default is-cropped meeting-gallery-original">
      <figure class="is-style-creative-1-a wp-block-image size-large">
        <img src="/uploads/2026/05/1928f3cfe16d762a92338a5d05c7048b-1024x768.jpg" alt="Sunday worship gathering" />
      </figure>
      <figure class="is-style-creative-1-b wp-block-image size-large">
        <img src="/uploads/2026/05/IMG_5542-1-scaled.jpg" alt="Church fellowship" />
      </figure>
      <figure class="is-style-creative-1-d wp-block-image size-large">
        <img src="/uploads/2026/05/64492981f90cd151588c735cd95c8f91-1024x768.jpg" alt="Church activity" />
      </figure>
    </figure>
  </section>
</section>
